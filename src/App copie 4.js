     ...
     try {
       if (Array.isArray(data)) {
         for (const item of data) {
           if (item.id) {
             await setDoc(doc(db, 'articles', item.id.toString()), item);
           }
         }
       }
     } catch (error) {
   ...
   const updateEquipements = async (data) => {
     try {
       if (Array.isArray(data)) {
         for (const item of data) {
           if (item.id) {
             await setDoc(doc(db, 'equipements', item.id.toString()), item);
           }
         }
       }
     } catch (error) {
   ...
   const updateDefauts = async (data) => {
     try {
       if (Array.isArray(data)) {
         for (const item of data) {
           if (item.id) {
             await setDoc(doc(db, 'defauts', item.id.toString()), item);
           }
         }
       }
     } catch (error) {
   ...
   const updateInterventions = async (data) => {
     try {
       if (Array.isArray(data)) {
         for (const item of data) {
           if (item.id) {
             await setDoc(doc(db, 'interventions', item.id.toString()), item);
           }
         }
       }
     } catch (error) {
   ...
   const updateMouvements = async (data) => {
     try {
       if (Array.isArray(data)) {
         for (const item of data) {
           if (item.id) {
             await setDoc(doc(db, 'mouvements', item.id.toString()), item);
           }
         }
       }
     } catch (error) {
...
useEffect(() => {
  ...
  const unsubscribeArticles = onSnapshot(collection(db, 'articles'), (snapshot) => {
    ...
    console.log('✅ Articles synchronisés en temps réel:', articlesData.length);
  });

  // Écoute temps réel des équipements
  const unsubscribeEquipements = onSnapshot(collection(db, 'equipements'), (snapshot) => {
    ...
    console.log('✅ Équipements synchronisés en temps réel:', equipementsData.length);
  });
