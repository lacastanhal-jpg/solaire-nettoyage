...
import { ChevronDown, Plus, Trash2, Edit2, AlertCircle, ArrowRight } from 'lucide-react';
...
export default function SolaireNettoyageFlotte() {
  ...
  // ===== DÉPÔTS =====
  const depots = [
    { id: 'atelier', nom: 'Atelier (Principal)', icon: '🏢' },
    { id: 'vehicule1', nom: 'Véhicule 1', icon: '🚗' },
    { id: 'vehicule2', nom: 'Véhicule 2', icon: '🚗' },
    { id: 'vehicule3', nom: 'Véhicule 3', icon: '🚗' },
  ];
  
  // ===== ARTICLES avec STOCKS PAR DÉPÔT =====
  const [articles, setArticles] = useState([
    { id: 1, code: 'BAC5X5', description: 'Barre pour clavette en acier 5x5', fournisseur: 'LE BON ROULEMENT', prixUnitaire: 5.05, stockMin: 2, equipementsAffectes: [], stocks: { atelier: 3, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 2, code: 'BAC8X7', description: 'Barre pour clavette en acier 8x7', fournisseur: 'LE BON ROULEMENT', prixUnitaire: 9.07, stockMin: 2, equipementsAffectes: [], stocks: { atelier: 3, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 3, code: '388518', description: 'Bague support pont avant', fournisseur: 'RURAL MASTER', prixUnitaire: 12.41, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 4, code: '605670', description: 'Washer 48.0x4.0 thrust', fournisseur: 'RURAL MASTER', prixUnitaire: 5.68, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 5, code: '606540', description: 'Nut M10x1.508 hex', fournisseur: 'RURAL MASTER', prixUnitaire: 2.06, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 6, code: '605669', description: 'Seal O ring 2.62x55.0', fournisseur: 'RURAL MASTER', prixUnitaire: 2.76, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 7, code: '606858', description: 'Grease nipple B M6', fournisseur: 'RURAL MASTER', prixUnitaire: 2.20, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 8, code: '605668', description: 'Dowel bush pillow block', fournisseur: 'RURAL MASTER', prixUnitaire: 3.59, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 2, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 9, code: '606739', description: 'Bolt M10x1.50x356.6P hex head', fournisseur: 'RURAL MASTER', prixUnitaire: 2.62, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 10, code: '388497', description: 'Support pont avant', fournisseur: 'RURAL MASTER', prixUnitaire: 53.02, stockMin: 1, equipementsAffectes: [], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 11, code: '764617', description: 'Chambre à air 20x108 STI', fournisseur: 'RURAL MASTER', prixUnitaire: 44.30, stockMin: 2, equipementsAffectes: [], stocks: { atelier: 3, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 12, code: 'HIFSO 8055', description: 'Filtre à huile', fournisseur: 'V6 AUTOPRO', prixUnitaire: 40.80, stockMin: 1, equipementsAffectes: [1], stocks: { atelier: 2, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 13, code: 'HIFSN 916020', description: 'Filtre à gasoil séparateur d\'eau', fournisseur: 'V6 AUTOPRO', prixUnitaire: 34.12, stockMin: 1, equipementsAffectes: [1], stocks: { atelier: 2, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 14, code: 'WY119802-55710', description: 'Séparateur d\'eau', fournisseur: 'CLAAS LAGARRIGUE', prixUnitaire: 15.05, stockMin: 1, equipementsAffectes: [6], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 15, code: 'WY123907-55810', description: 'Filtre combustible', fournisseur: 'CLAAS LAGARRIGUE', prixUnitaire: 36.88, stockMin: 1, equipementsAffectes: [6], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 16, code: 'WY129150-35170', description: 'Filtre à huile', fournisseur: 'CLAAS LAGARRIGUE', prixUnitaire: 14.17, stockMin: 1, equipementsAffectes: [6], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 17, code: '44524021', description: 'Filtre TRANS (TTR/TRH 9800) PONT AV', fournisseur: 'CLAAS LAGARRIGUE', prixUnitaire: 31.65, stockMin: 1, equipementsAffectes: [6], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 18, code: '44524020', description: 'Filtre HYDRAU PRESSION', fournisseur: 'CLAAS LAGARRIGUE', prixUnitaire: 62.71, stockMin: 1, equipementsAffectes: [6], stocks: { atelier: 1, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
    { id: 19, code: 'BF16', description: 'Huile BF16 (20L)', fournisseur: 'SARL QUIERS', prixUnitaire: 5.07, stockMin: 10, equipementsAffectes: [6], stocks: { atelier: 40, vehicule1: 0, vehicule2: 0, vehicule3: 0 } },
  ]);
  ...
  const [accessoiresEquipement, setAccessoiresEquipement] = useState({
    ...
    6: [
      { id: 9, nom: 'SunBrush mobil TrackFlex 3.0', valeur: 64277.00, dateAjout: '2025-05-14', description: 'SunBrush mobil TrackFlex 3.0 5,5m brush trim 350mm - Cleaning device 5.5m brush', actif: true },
    ]
  });

  // ===== INTERVENTIONS =====
  const [interventions, setInterventions] = useState([
    { id: 1, equipementId: 3, type: 'Révision/Maintenance', date: '2023-10-31', km: 363392, heures: 0, description: 'Entretien atelier', articles: [], statut: 'effectue', coutTotal: 7635.12, depot: 'atelier' }
  ]);
  ...
  const [nouvelTransfert, setNouvelTransfert] = useState({ articleId: '', quantite: '', depotSource: 'atelier', depotDest: 'vehicule1' });
  const [nouvelleIntervention, setNouvelleIntervention] = useState({ equipementId: '', type: '', date: new Date().toISOString().split('T')[0], km: '', heures: '', description: '', articlesPrevu: [], depot: 'atelier' });
  ...
  const enregistrerEntreeStock = () => {
    if (nouvelleEntreeStock.articleId && nouvelleEntreeStock.quantite && nouvelleEntreeStock.prixUnitaire && nouvelleEntreeStock.depot) {
      const quantite = parseInt(nouvelleEntreeStock.quantite);
      const coutTotal = parseFloat(nouvelleEntreeStock.prixUnitaire) * quantite;
      
      setArticles(articles.map(a => a.id === parseInt(nouvelleEntreeStock.articleId) 
        ? { ...a, stocks: { ...a.stocks, [nouvelleEntreeStock.depot]: a.stocks[nouvelleEntreeStock.depot] + quantite } } 
        : a
      ));
  ...
  const enregistrerSortieStock = () => {
    if (nouveauMouvementSortie.articleId && nouveauMouvementSortie.quantite && nouveauMouvementSortie.depot) {
      ...
      if (article.stocks[nouveauMouvementSortie.depot] < quantite) { alert('Stock insuffisant dans ce dépôt!'); return; }
      
      setArticles(articles.map(a => a.id === parseInt(nouveauMouvementSortie.articleId)
        ? { ...a, stocks: { ...a.stocks, [nouveauMouvementSortie.depot]: a.stocks[nouveauMouvementSortie.depot] - quantite } }
        : a
      ));
  ...
  const transfererArticle = () => {
    if (nouvelTransfert.articleId && nouvelTransfert.quantite && nouvelTransfert.depotSource !== nouvelTransfert.depotDest) {
      const article = articles.find(a => a.id === parseInt(nouvelTransfert.articleId));
      const quantite = parseInt(nouvelTransfert.quantite);
      if (article.stocks[nouvelTransfert.depotSource] < quantite) { alert('Stock insuffisant!'); return; }
      
      setArticles(articles.map(a => a.id === parseInt(nouvelTransfert.articleId)
        ? { ...a, stocks: { ...a.stocks, [nouvelTransfert.depotSource]: a.stocks[nouvelTransfert.depotSource] - quantite, [nouvelTransfert.depotDest]: a.stocks[nouvelTransfert.depotDest] + quantite } }
        : a
      ));
      
      setMouvementsStock([...mouvementsStock, {
        id: mouvementsStock.length + 1,
        articleId: parseInt(nouvelTransfert.articleId),
        type: 'transfert',
        quantite: quantite,
        date: new Date().toISOString().split('T')[0],
        raison: `Transfert de ${depots.find(d => d.id === nouvelTransfert.depotSource)?.nom} à ${depots.find(d => d.id === nouvelTransfert.depotDest)?.nom}`,
        coutTotal: 0,
        depot: nouvelTransfert.depotSource
      }]);
      
      setNouvelTransfert({ articleId: '', quantite: '', depotSource: 'atelier', depotDest: 'vehicule1' });
    }
  };
  ...
  const ajouterArticlePrevu = () => {
    if (nouvelArticleIntervention.articleId && nouvelArticleIntervention.quantite) {
      ...
      if (article.stocks[nouvelleIntervention.depot] < quantite) { alert('Stock insuffisant dans ce dépôt'); return; }
  ...
  const creerIntervention = () => {
    ...
    nouvelleIntervention.articlesPrevu.forEach(art => {
      nouvelStock = nouvelStock.map(a => a.id === art.articleId ? { ...a, stocks: { ...a.stocks, [nouvelleIntervention.depot]: a.stocks[nouvelleIntervention.depot] - art.quantite } } : a);
    });
    ...
    setInterventions([...interventions, {
      ...
      statut: 'en_cours',
      coutTotal: coutTotal,
      depot: nouvelleIntervention.depot
    }]);
    
    setNouvelleIntervention({ equipementId: '', type: '', date: new Date().toISOString().split('T')[0], km: '', heures: '', description: '', articlesPrevu: [], depot: 'atelier' });
  };
  ...
  const genererTexteCommande = (article) => {
    const stockTotal = article.stocks.atelier + article.stocks.vehicule1 + article.stocks.vehicule2 + article.stocks.vehicule3;
    const qteACommander = Math.max(0, article.stockMin - stockTotal);
...
<table style="border-collapse: collapse; width: 100%; max-width: 800px; margin-bottom: 30px;">
  ...
  // ===== FONCTIONS CALCUL =====
  const getStockTotal = (article) => article.stocks.atelier + article.stocks.vehicule1 + article.stocks.vehicule2 + article.stocks.vehicule3;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white p-4">
        <h1 className="text-2xl font-bold">☀️ SOLAIRE NETTOYAGE - Gestion Multi-Stocks</h1>
        <p className="text-yellow-100 text-sm">Atelier • Véhicules • Multi-dépôts • Interventions</p>
      </div>
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10 overflow-x-auto">
        <div className="flex">
          {[
            ...
            { id: 'stock', label: '📥 Stock Multi-Dépôts' },
      ...
      <div className="p-6 max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <div className="bg-indigo-50 p-4 rounded border border-indigo-200">
                ...
                <div className="text-sm">Valeur total</div>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="font-black text-lg mb-4">🏢 Répartition par dépôt</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {depots.map(depot => {
                  const stockDepot = articles.reduce((sum, a) => sum + a.stocks[depot.id], 0);
                  const valeurDepot = articles.reduce((sum, a) => sum + (a.stocks[depot.id] * a.prixUnitaire), 0);
                  return (
                    <div key={depot.id} className="bg-gradient-to-br from-orange-50 to-yellow-50 p-4 rounded-lg border-2 border-orange-200">
                      <div className="text-2xl mb-2">{depot.icon}</div>
                      <div className="font-bold text-orange-600">{depot.nom}</div>
                      <div className="text-2xl font-black text-orange-700 mt-2">{stockDepot}</div>
                      <div className="text-xs text-gray-600 mt-1">{valeurDepot.toFixed(0)}€</div>
                    </div>
                  );
                })}
              </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-green-50 border-2 border-green-300 p-6 rounded-lg">
                <h3 className="font-black mb-4 text-green-700">📥 Entrée de stock</h3>
                <div className="space-y-2">
                  <select value={nouvelleEntreeStock.articleId} onChange={(e) => setNouvelleEntreeStock({...nouvelleEntreeStock, articleId: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm">
                    <option value="">Article *</option>
                    {articles.map(a => <option key={a.id} value={a.id}>{a.code} - {a.description}</option>)}
                  </select>
                  <select value={nouvelleEntreeStock.depot} onChange={(e) => setNouvelleEntreeStock({...nouvelleEntreeStock, depot: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm">
                    {depots.map(d => <option key={d.id} value={d.id}>{d.nom}</option>)}
                  </select>
                  <input type="number" placeholder="Quantité" value={nouvelleEntreeStock.quantite} onChange={(e) => setNouvelleEntreeStock({...nouvelleEntreeStock, quantite: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <input type="number" step="0.01" placeholder="Prix unitaire" value={nouvelleEntreeStock.prixUnitaire} onChange={(e) => setNouvelleEntreeStock({...nouvelleEntreeStock, prixUnitaire: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <input type="text" placeholder="Raison" value={nouvelleEntreeStock.raison} onChange={(e) => setNouvelleEntreeStock({...nouvelleEntreeStock, raison: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <input type="date" value={nouvelleEntreeStock.date} onChange={(e) => setNouvelleEntreeStock({...nouvelleEntreeStock, date: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <button onClick={enregistrerEntreeStock} className="w-full bg-green-600 text-white px-4 py-2 rounded font-bold hover:bg-green-700">✓ Enregistrer</button>
                </div>
              </div>

              {/* SORTIE */}
              <div className="bg-red-50 border-2 border-red-300 p-6 rounded-lg">
                <h3 className="font-black mb-4 text-red-700">📤 Sortie de stock</h3>
                <div className="space-y-2">
                  <select value={nouveauMouvementSortie.articleId} onChange={(e) => setNouveauMouvementSortie({...nouveauMouvementSortie, articleId: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm">
                    <option value="">Article *</option>
                    {articles.map(a => <option key={a.id} value={a.id}>{a.code} - {a.description}</option>)}
                  </select>
                  <select value={nouveauMouvementSortie.depot} onChange={(e) => setNouveauMouvementSortie({...nouveauMouvementSortie, depot: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm">
                    {depots.map(d => <option key={d.id} value={d.id}>{d.nom}</option>)}
                  </select>
                  <input type="number" placeholder="Quantité" value={nouveauMouvementSortie.quantite} onChange={(e) => setNouveauMouvementSortie({...nouveauMouvementSortie, quantite: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <input type="text" placeholder="Raison" value={nouveauMouvementSortie.raison} onChange={(e) => setNouveauMouvementSortie({...nouveauMouvementSortie, raison: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <input type="date" value={nouveauMouvementSortie.date} onChange={(e) => setNouveauMouvementSortie({...nouveauMouvementSortie, date: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <button onClick={enregistrerSortieStock} className="w-full bg-red-600 text-white px-4 py-2 rounded font-bold hover:bg-red-700">✓ Sortir</button>
                </div>
              </div>

              {/* TRANSFERT */}
              <div className="bg-blue-50 border-2 border-blue-300 p-6 rounded-lg">
                <h3 className="font-black mb-4 text-blue-700">🔄 Transfert entre dépôts</h3>
                <div className="space-y-2">
                  <select value={nouvelTransfert.articleId} onChange={(e) => setNouvelTransfert({...nouvelTransfert, articleId: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm">
                    <option value="">Article *</option>
                    {articles.map(a => <option key={a.id} value={a.id}>{a.code} - {a.description}</option>)}
                  </select>
                  <select value={nouvelTransfert.depotSource} onChange={(e) => setNouvelTransfert({...nouvelTransfert, depotSource: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm">
                    <option value="">Source *</option>
                    {depots.map(d => <option key={d.id} value={d.id}>{d.nom}</option>)}
                  </select>
                  <select value={nouvelTransfert.depotDest} onChange={(e) => setNouvelTransfert({...nouvelTransfert, depotDest: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm">
                    <option value="">Destination *</option>
                    {depots.map(d => <option key={d.id} value={d.id}>{d.nom}</option>)}
                  </select>
                  <input type="number" placeholder="Quantité" value={nouvelTransfert.quantite} onChange={(e) => setNouvelTransfert({...nouvelTransfert, quantite: e.target.value})} className="w-full border-2 rounded px-3 py-2 text-sm" />
                  <button onClick={transfererArticle} className="w-full bg-blue-600 text-white px-4 py-2 rounded font-bold hover:bg-blue-700">↔️ Transférer</button>
                </div>
              </div>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="font-black text-lg mb-4">📊 État des stocks par dépôt</h3>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-orange-50 border-b-2 border-orange-300">
                      ...
                      {depots.map(d => <th key={d.id} className="px-2 py-2 text-center font-bold text-xs">{d.icon}</th>)}
                      <th className="px-3 py-2 text-center font-bold">Total</th>
                      <th className="px-3 py-2 text-center font-bold">Prix</th>
                      <th className="px-3 py-2 text-center font-bold">Valeur</th>
                      <th className="px-3 py-2 text-center font-bold">Min</th>
                  ...
                  <tbody>
                    {articles.map(a => {
                      ...
                      return (
                        <tr key={a.id} className={`border-b ${enAlerte ? 'bg-red-50' : 'bg-white'}`}>
                          <td className="px-3 py-2 font-bold text-orange-600">{a.code}</td>
                          <td className="px-3 py-2 text-xs">{a.description}</td>
                          {depots.map(d => (
                            <td key={d.id} className="px-2 py-2 text-center font-semibold">{a.stocks[d.id]}</td>
                          ))}
                          <td className="px-3 py-2 text-center font-bold">{total}</td>
                          <td className="px-3 py-2 text-center">{a.prixUnitaire}€</td>
                          <td className="px-3 py-2 text-center font-bold">{(total * a.prixUnitaire).toFixed(2)}€</td>
                          <td className="px-3 py-2 text-center">
                            <button onClick={() => ouvrirEditionStockMin(a)} className="text-blue-600 hover:underline font-bold cursor-pointer text-lg">{a.stockMin}</button>
                          </td>
                          <td className="px-3 py-2 text-center">
                            {enAlerte ? (
            ...
            <div className="bg-white p-6 rounded-xl shadow-md mt-6">
              <h3 className="font-black text-lg mb-4">🎯 Affecter articles aux équipements</h3>
              <div className="space-y-2">
                {articles.map(a => {
                  ...
                  return (
                    <div key={a.id} className={`flex justify-between items-center p-3 rounded border-2 ${isAffecte ? 'bg-blue-100 border-blue-400' : 'bg-gray-50 border-gray-200'}`}>
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-600">Stock total: {getStockTotal(a)} × {isAffecte ? `✓ Affecté à: ${[...equipAffectes.map(e => e.immat), ...accessoiresActifsAffectes].join(', ')}` : 'Non affecté'}</div>
                      </div>
        ...
        {ongletActif === 'interventions' && (
          <div className="space-y-4">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="font-bold text-lg mb-4">🔧 Créer intervention</h3>
              <div className="space-y-3">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                  <select value={nouvelleIntervention.equipementId} onChange={(e) => setNouvelleIntervention({...nouvelleIntervention, equipementId: e.target.value})} className="border-2 rounded px-3 py-2">
                    <option value="">Équipement *</option>
                    {equipements.map(eq => <option key={eq.id} value={eq.id}>{eq.immat} - {eq.marque} {eq.modele}</option>)}
                  </select>
                  <select value={nouvelleIntervention.type} onChange={(e) => setNouvelleIntervention({...nouvelleIntervention, type: e.target.value})} className="border-2 rounded px-3 py-2">
                    <option value="">Type *</option>
                    {typesIntervention.map(t => <option key={t} value={t}>{t}</option>)}
                  </select>
                  <select value={nouvelleIntervention.depot} onChange={(e) => setNouvelleIntervention({...nouvelleIntervention, depot: e.target.value})} className="border-2 rounded px-3 py-2 bg-blue-50 font-semibold">
                    {depots.map(d => <option key={d.id} value={d.id}>{d.nom}</option>)}
                  </select>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                  <input type="date" value={nouvelleIntervention.date} onChange={(e) => setNouvelleIntervention({...nouvelleIntervention, date: e.target.value})} className="border-2 rounded px-3 py-2" />
                  <input type="number" placeholder="KM" value={nouvelleIntervention.km} onChange={(e) => setNouvelleIntervention({...nouvelleIntervention, km: e.target.value})} className="border-2 rounded px-3 py-2" />
                  <input type="number" placeholder="Heures" value={nouvelleIntervention.heures} onChange={(e) => setNouvelleIntervention({...nouvelleIntervention, heures: e.target.value})} className="border-2 rounded px-3 py-2" />
                  <input type="text" placeholder="Description" value={nouvelleIntervention.description} onChange={(e) => setNouvelleIntervention({...nouvelleIntervention, description: e.target.value})} className="border-2 rounded px-3 py-2" />
                </div>

                <div className="bg-blue-50 border-2 border-blue-300 p-4 rounded">
                  <h4 className="font-semibold text-sm mb-3">📦 Articles du dépôt sélectionné ({nouvelleIntervention.depot ? depots.find(d => d.id === nouvelleIntervention.depot)?.nom : 'Sélectionner un dépôt'})</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-3">
                    <select value={nouvelArticleIntervention.articleId} onChange={(e) => setNouvelArticleIntervention({...nouvelArticleIntervention, articleId: e.target.value})} className="border-2 rounded px-2 py-2 text-sm col-span-2">
                      <option value="">Sélectionner article</option>
                      {articles.map(a => {
                        const dispo = a.stocks[nouvelleIntervention.depot] || 0;
                        return <option key={a.id} value={a.id}>{a.code} - {a.description} (Stock: {dispo})</option>;
                      })}
                    </select>
                  ...
                  <button onClick={ajouterArticlePrevu} className="w-full bg-blue-600 text-white px-3 py-2 rounded text-sm font-bold mb-2">+ Ajouter article</button>
                  
                  {nouvelleIntervention.articlesPrevu.length > 0 && (
                    <div className="bg-white rounded p-2 space-y-1 border border-blue-200">
                      {nouvelleIntervention.articlesPrevu.map((art, idx) => (
                        <div key={idx} className="flex justify-between items-center text-xs bg-blue-50 p-2 rounded">
                          ...
                          <button onClick={() => supprimerArticlePrevu(idx)} className="text-red-600 hover:text-red-900 font-bold">✕</button>
                        </div>
                      ))}
                    </div>
                  )}
            ...
            {interventionsEnCours.length > 0 && (
              <div>
                <h3 className="font-bold text-lg mb-3">En cours ({interventionsEnCours.length})</h3>
                {interventionsEnCours.map(i => {
                  const eq = equipements.find(e => e.id === i.equipementId);
                  const depot = depots.find(d => d.id === i.depot);
                  return (
                    <div key={i.id} className="bg-yellow-50 border-2 border-yellow-400 p-4 rounded mb-3">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{eq?.immat} - {i.date} - Dépôt: {depot?.nom}</p>
                        </div>
            ...
            {interventions.filter(i => i.statut === 'effectue').length > 0 && (
              <div>
                <h3 className="font-bold text-lg mb-3">Effectuées</h3>
                    ...
                    <div key={i.id} className="p-4 bg-green-50 rounded mb-3 border border-green-300">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-700"><strong>{eq?.immat}</strong> • {i.date} • Dépôt: {depot?.nom}</p>
                        </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-xl max-w-md w-full mx-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-t pt-3">
                      <label className="block text-sm font-bold text-orange-600 mb-1">Stock Minimum Global *</label>
            ...
            {panierCommande.length > 0 && (
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-xl shadow-lg">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => setPanierCommande([])} className="flex-1 bg-red-500 text-white px-6 py-3 rounded font-black text-lg hover:bg-red-600">🗑️ Vider</button>
                </div>
              </div>
            )}

            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="font-black text-lg mb-4">📦 Tous les articles</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-orange-50 border-b-2 border-orange-300">
                      <th className="px-3 py-2 text-left font-bold">Code</th>
                      <th className="px-3 py-2 text-left font-bold">Description</th>
                      <th className="px-3 py-2 text-right font-bold">Prix</th>
                    ...
                    {articles.map(a => {
                      ...
                      return (
                        <tr key={a.id} className={`border-b ${enAlerte ? 'bg-red-50' : ''}`}>
                          <td className="px-3 py-2 font-semibold text-orange-600">{a.code}</td>
                          <td className="px-3 py-2">{a.description}</td>
                          <td className="px-3 py-2 text-right">{a.prixUnitaire}€</td>
                          <td className={`px-3 py-2 text-center font-bold ${enAlerte ? 'text-red-600' : 'text-green-600'}`}>{total}</td>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              {articlesAffectesEquipement.length === 0 ? (
                <p className="text-gray-500 italic text-center py-4">Aucun article affecté</p>
              ) : (
                <div className="space-y-2">
                  {articlesAffectesEquipement.map(a => (
                    <div key={a.id} className="flex justify-between p-3 bg-purple-50 rounded-lg border border-purple-200">
                      ...
                      <div className="text-right font-bold">
                        <div className="text-purple-600">Total: {getStockTotal(a)}</div>
        ...
        {ongletActif === 'articles' && (
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="font-black text-lg mb-4">📦 Articles ({articles.length})</h3>
            <div className="space-y-2">
              {articles.map(a => {
                const total = getStockTotal(a);
                return (
                  <div key={a.id} className="flex justify-between p-3 bg-gray-50 rounded hover:bg-orange-50 transition">
                    <div>
                      <strong className="text-orange-600">{a.code}</strong> - {a.description}
                    </div>
                    <div className="text-right"><span className={`font-bold ${total <= 2 ? 'text-red-600' : 'text-green-600'}`}>{total}</span> × {a.prixUnitaire}€</div>
                  </div>
                );
              })}
            </div>
        ...
        {ongletActif === 'equipements' && (
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="font-black text-lg mb-4">Équipements ({equipements.length})</h3>
            {equipements.map(eq => (
        ...
        {ongletActif === 'maintenance' && (
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="font-black text-lg mb-4">⚙️ Plan de maintenance</h3>
